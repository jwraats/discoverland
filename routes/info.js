var info = {
	...
	exportMeetwaarden:  function(req, res) {
		...
		db.query(query, function (err, rows, fields){	
			...
			res.json({status:1, id:meetopstelling.id, longitude:meetopstelling.long, latitude:meetopstelling.lat, beschrijving:meetopstelling.beschrijving, data : results});
		});
	},
